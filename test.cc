...
const char *dbfile_dir = "/Users/vishy/parsedData/"; // dir where binary heap files should be stored
const char *tpch_dir ="/Users/vishy/data/"; // dir where dbgen tpch files (extension *.tbl) can be found
